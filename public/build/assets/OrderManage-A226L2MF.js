import{u as b,r as x,j as e,H as y,a as w}from"./app-Da47nSBp.js";import{A as j}from"./AuthenticatedLayout-CRgTGhso.js";import{I as N}from"./InventoryStaffLayout-CoHPJu3f.js";import{P as v}from"./ProductionStaffLayout-CmgeHzXb.js";import{A as k}from"./AccountingStaffLayout-Ep1LM-F1.js";import{C as S}from"./CashierStaffLayout-CP-9KpcJ.js";import{M as R}from"./MarketingSalesStaffLayout-DQdl77v0.js";import"./ApplicationLogo-CnWRV66F.js";function C({auth:i,orders:m}){const{auth:g}=b().props,a=Number((i||g)?.user?.role_id),u=a===4?N:a===5?v:a===6?k:a===7?S:a===8?R:j,[l,r]=x.useState(null),[n,h]=x.useState("In Process"),d=(t,s)=>{r(t),w.patch(route("staff.orders.update",{transaction:t}),{status:s},{onFinish:()=>r(null),preserveScroll:!0})},f=t=>{const s=window.open("","_blank");s.document.write(`
            <html>
                <head>
