import{u as b,r as x,j as e,H as y,a as w}from"./app-BLl8_Q0m.js";import{A as j}from"./AuthenticatedLayout-b_QG3tfn.js";import{I as N}from"./InventoryStaffLayout-DOG_0Ars.js";import{P as v}from"./ProductionStaffLayout-dqRJVijy.js";import{A as k}from"./AccountingStaffLayout-DUhEGhAA.js";import{C as S}from"./CashierStaffLayout-BX7-u_0E.js";import{M as R}from"./MarketingSalesStaffLayout-BBnCQ-r5.js";import"./ApplicationLogo-Cdw9hksg.js";function C({auth:i,orders:m}){const{auth:g}=b().props,a=Number((i||g)?.user?.role_id),u=a===4?N:a===5?v:a===6?k:a===7?S:a===8?R:j,[l,r]=x.useState(null),[n,h]=x.useState("In Process"),d=(t,s)=>{r(t),w.patch(route("staff.orders.update",{transaction:t}),{status:s},{onFinish:()=>r(null),preserveScroll:!0})},f=t=>{const s=window.open("","_blank");s.document.write(`
            <html>
                <head>
