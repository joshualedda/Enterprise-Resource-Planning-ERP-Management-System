...
export default function AccountingStaffLayout({ header, children }) {
    ...
    const navigation = useMemo(() => [
        ...
        { separator: 'Core Accounting' },
        {
            name: 'Chart of Accounts',
            href: route().has('staff.accounting.chart-of-accounts.index') ? route('staff.accounting.chart-of-accounts.index') : '#',
            icon: 'M4 6h16M4 10h16M4 14h16M4 18h16', // Simple list icon
        },
        {
            name: 'Journal Entries',
            href: route().has('staff.accounting.journal-entries.index') ? route('staff.accounting.journal-entries.index') : '#',
            icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z', // Edit icon
        },
        { separator: 'Transactions' },
        {
            name: 'Payments',
            icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2z', // Cash/Card icon
            children: [
                { name: 'Customer Payments', href: route().has('staff.accounting.customer-payments.index') ? route('staff.accounting.customer-payments.index') : '#' },
                { name: 'Supplier Payments', href: route().has('staff.accounting.supplier-payments.index') ? route('staff.accounting.supplier-payments.index') : '#' },
            ],
        },
        { separator: 'Analysis' },
        {
            ...
            children: [
                { name: 'Trial Balance',  href: route().has('staff.accounting.trial-balance.index') ? route('staff.accounting.trial-balance.index') : '#' },
                { name: 'Profit & Loss',  href: route().has('staff.accounting.profit-and-loss.index') ? route('staff.accounting.profit-and-loss.index') : '#' },
                { name: 'Balance Sheet',  href: route().has('staff.accounting.balance-sheet.index') ? route('staff.accounting.balance-sheet.index') : '#' },
            ],
        },
        { separator: 'Account' },
        {
