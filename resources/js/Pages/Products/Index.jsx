                            ...
                            {products.map((product) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        key={product.id}
                                        className="group bg-white rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden block relative"
                                    >
                                        {/* Category Badge sa Top Right */}
                                        <div className="absolute top-4 right-4 z-10 pointer-events-none">
                                            <span className="bg-white/90 backdrop-blur-md text-indigo-600 text-[9px] font-black uppercase px-2.5 py-1.5 rounded-xl border border-slate-100 shadow-sm">
                                        ...
                                        <div className="p-6">
                                            <div className="mb-4">
                                                <h3 className="text-base font-bold text-slate-800 truncate mb-1 group-hover:text-indigo-600 transition-colors">
                                                    {product.product}
                                                </h3>
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        ...
                                                        {isOutOfStock ? (
                                                            ...
                                                            <span className="w-fit bg-amber-50 text-amber-600 text-[8px] font-black uppercase px-2 py-0.5 rounded-md border border-amber-100">
                                                                Low Stock
                                                            </span>
                                                        ) : null}
                                                    </div>
                    ...
                    categories && categories.length > 0 ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {categories.map((category) => (
                                <div
                                    key={category.id}
                                    className="group bg-white rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300 p-6 flex flex-col justify-between"
                                >
