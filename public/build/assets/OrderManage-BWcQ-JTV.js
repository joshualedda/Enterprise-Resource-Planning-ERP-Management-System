import{r as p,j as e,H as h,c as u}from"./app-B7EvgdWA.js";import{A as b}from"./AuthenticatedLayout-LlGrcOuB.js";import"./ApplicationLogo-Bm1BF2o7.js";import"./transition-DNS8K6Nw.js";function N({auth:n,orders:x}){const[l,o]=p.useState(null),[i,g]=p.useState("In Process"),r=(t,s)=>{o(t),u.patch(route("staff.orders.update",{transaction:t}),{status:s},{onFinish:()=>o(null),preserveScroll:!0})},m=t=>{const s=window.open("","_blank");s.document.write(`
            <html>
                <head>
