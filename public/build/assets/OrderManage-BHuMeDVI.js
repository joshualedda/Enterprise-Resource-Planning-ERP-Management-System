import{u as b,r as x,j as e,H as y,a as w}from"./app-BieOsm83.js";import{A as j}from"./AuthenticatedLayout-BFebnsHN.js";import{I as N}from"./InventoryStaffLayout-BehtkA6p.js";import{P as v}from"./ProductionStaffLayout-BCFqJswr.js";import{A as k}from"./AccountingStaffLayout-BpqmLsad.js";import{C as S}from"./CashierStaffLayout-BFV4Mynm.js";import{M as R}from"./MarketingSalesStaffLayout-BJqiD9Hi.js";import"./ApplicationLogo-CZeWPP0t.js";function C({auth:i,orders:m}){const{auth:g}=b().props,a=Number((i||g)?.user?.role_id),u=a===4?N:a===5?v:a===6?k:a===7?S:a===8?R:j,[l,r]=x.useState(null),[n,h]=x.useState("In Process"),d=(t,s)=>{r(t),w.patch(route("staff.orders.update",{transaction:t}),{status:s},{onFinish:()=>r(null),preserveScroll:!0})},f=t=>{const s=window.open("","_blank");s.document.write(`
            <html>
                <head>
